...
const MediaPoster = ({ media }: any) => {
  ...
  return (
    ...
    >
      ...
      />
      <div className="flex flex-col justify-between h-full tracking-tighter leading-tighter  absolute top-0 left-0 p-3 text-white opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300">
        <Chip
          size="sm"
